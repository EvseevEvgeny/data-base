...
create view TOP_10_DET as 
	select first 10 DET_ALL_Y.ID_DETAIL, DETAILS_CATALOG.NAME, 
		(DET_ALL_N.AMOUNT - DET_ALL_Y.AMOUNT) as AMT
	from DET_ALL_Y, DET_ALL_N, DETAILS_CATALOG
	where DET_ALL_Y.VIN = DET_ALL_N.VIN and DET_ALL_Y.ID_DETAIL_NAME = DET_ALL_N.ID_DETAIL_NAME
		and DET_ALL_Y.ID_DETAIL = DETAILS_CATALOG.ID_DATAIL
	order by AMT desc;
